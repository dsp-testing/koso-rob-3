...
FROM rust:1.88.0@sha256:a5c5c4b34e4742c068ed35e31c171443d4be3a417e419d03339dad7001d3f903 AS sqlx
WORKDIR /app
COPY rust-toolchain.toml ./
RUN cargo install sqlx-cli@=0.8.6 --locked --no-default-features --features native-tls,postgres --root ./

FROM node:24.4.1@sha256:60d70c05d27c936324c52ba9e74e548c75087adb341b0c63f2d796a138006e89 AS frontend
ENV PNPM_HOME="/pnpm"
